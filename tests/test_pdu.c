...
void
t_parse_pdu1(void) {
  unsigned char teststr[] = {  0x40, 0x01, 0x93, 0x34 };
  int result;
...
void
t_parse_pdu2(void) {
  unsigned char teststr[] = {  0x55, 0x69, 0x12, 0x34, 't', 'o', 'k', 'e', 'n' };
  int result;
...
void
t_parse_pdu3(void) {
  unsigned char teststr[] = {  0x53, 0x69, 0x12, 0x34, 't', 'o', 'k', 'e', 'n' };
  int result;
...
t_parse_pdu4(void) {
  ...
  unsigned char teststr[] = {  0x59, 0x69, 0x12, 0x34, 
		      't', 'o', 'k', 'e', 'n', '1', '2', '3', '4' };
  int result;
...
t_parse_pdu5(void) {
  /* PDU with options */
  unsigned char teststr[] = {  0x55, 0x73, 0x12, 0x34, 't', 'o', 'k', 'e', 
		      'n',  0x00, 0xc1, 0x00
  };
  int result;
...
t_parse_pdu8(void) {
  ...
  unsigned char teststr[] = {  0x50, 0x73, 0x12, 0x34, 
		      0xff, 'p', 'a', 'y', 'l', 'o', 'a', 
		      'd'
  };
  int result;
...
t_parse_pdu9(void) {
  ...
  unsigned char teststr[] = {  0x70, 0x00, 0x12, 0x34, 0xff };
  int result;
...
t_parse_pdu10(void) {
  ...
  unsigned char teststr[] = {  0x53, 0x73, 0x12, 0x34, 't', 'o', 'k', 
		      0x30, 0xc1, 0x00, 0xff 
  };
  int result;
...
void
t_parse_pdu11(void) {
  unsigned char teststr[] = {  0x60, 0x00, 0x12, 0x34 };
  int result;
...
t_parse_pdu12(void) {
  /* RST */
  unsigned char teststr[] = {  0x70, 0x00, 0x12, 0x34 };
  int result;
...
void
t_encode_pdu1(void) {
  unsigned char teststr[] = { 0x45, 0x01, 0x12, 0x34, 't', 'o', 'k', 'e', 'n' };
  int result;
...
t_encode_pdu4(void) {
  /* PDU with options */
  unsigned char teststr[] = { 0x60, 0x99, 0x12, 0x34, 0x3d, 0x05, 0x66, 0x61,
...
t_encode_pdu5(void) {
  ...
  unsigned char teststr[] = { 0x68, 0x84, 0x12, 0x34, '1',  '2',  '3',  '4',
...
t_encode_pdu6(void) {
  /* PDU with data */
  unsigned char teststr[] = { 0x50, 0x02, 0x12, 0x34, 0xff, '1',  '2',  '3',  
		     '4', '5',  '6',  '7',  '8'
  };
  coap_pdu_clear(pdu, pdu->max_size);	/* clear PDU */
...
t_encode_pdu7(void) {
  /* PDU with empty data */
  unsigned char teststr[] = { 0x40, 0x43, 0x12, 0x34 };
  int result;
  coap_pdu_clear(pdu, pdu->max_size);	/* clear PDU */
...
t_encode_pdu8(void) {
  ...
  unsigned char teststr[] = { 0x42, 0x43, 0x12, 0x34, 0x00, 0x01, 0xff, 0x00 };
  int result;
  coap_pdu_clear(pdu, pdu->max_size);	/* clear PDU */
...
t_encode_pdu9(void) {
  ...
  unsigned char teststr[] = { 0x60, 0x44, 0x12, 0x34, 0x48, 's',  'o',  'm',
...
t_encode_pdu10(void) {
  ...
  unsigned char teststr[] = { 0x62, 0x44, 0x12, 0x34, 0x00, 0x00, 0x8d, 0xf2, 
		     'c',  'o',  'a',  'p',  ':',  '/',  '/',  'e',  
		     'x',  'a',  'm',  'p',  'l',  'e',  '.',  'c',
		     'o',  'm',  '/',  '1',  '2',  '3',  '4',  '5',
		     '/',  '%',  '3',  'F',  'x',  'y',  'z',  '/',
