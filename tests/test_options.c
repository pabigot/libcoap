...
t_encode_option2(void) {
  unsigned char teststr[] = { 0x5d, 0xff };
  unsigned char buf[40];
  size_t result;
...
t_encode_option3(void) {
  unsigned char teststr[] = { 0xd1, 0x01 };
  unsigned char buf[40];
  size_t result;
...
t_encode_option4(void) {
  unsigned char teststr[] = { 0xdd, 0xff, 0xab };
  unsigned char buf[40];
  size_t result;
...
t_encode_option5(void) {
  unsigned char teststr[] = { 0xed, 0x13, 0x00, 0xff };
  unsigned char buf[40];
  size_t result;
...
t_encode_option6(void) {
  unsigned char teststr[] = { 0xee, 0xfe, 0xf2, 0xfe, 0xf2 };
  unsigned char buf[40];
  size_t result;
...
t_encode_option7(void) {
  unsigned char teststr[] = { 0x35, 'v', 'a', 'l', 'u', 'e' };
...
t_access_option1(void) {
  const unsigned char teststr[] = { 0x12, 'a', 'b' };
...
t_access_option2(void) {
  const unsigned char teststr[] = { 0xe2, 0x18, 0xfd, 'a', 'b' };
...
t_access_option3(void) {
  const unsigned char teststr[] = { 0xed, 0x18, 0x0a, 0x00, 'a', 'b', 'c', 'd', 
			   'e',  'f',  'g',  'h',  'i', 'j', 'k', 'l',
			   'm'
  };
...
t_access_option4(void) {
  const unsigned char teststr[] = { 0xde, 0xff, 0xfe, 0xf2, 'a', 'b', 'c' };
...
t_access_option5(void) {
  const unsigned char teststr[] = { 0xee, 0xfe, 0xf2, 0x00, 0xdd, 'a', 'b', 'c' };
...
t_access_option6(void) {
  const unsigned char teststr[] = { 0xf2, 'a', 'b' };
...
t_access_option7(void) {
  const unsigned char teststr[] = { 0x2f, 'a', 'b' };
